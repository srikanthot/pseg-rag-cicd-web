"""
Streamlit Mobile UI for the MANGOS Tech Manual Assistant.
...
st.set_page_config(
    page_title="MANGOS Mobile Assistant",
    page_icon="📱",
    layout="wide",
...
def render_mobile_header():
    """Render compact mobile header matching MANGOS branding."""
    st.markdown("""
...
def main():
    ...
    # Chat input
    if prompt := st.chat_input("Ask about MANGOS manuals..."):
