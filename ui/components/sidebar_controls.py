...
# MANGOS SVG Logo for sidebar (navy text for light background)
SIDEBAR_LOGO_SVG = '''
<svg viewBox="0 0 180 45" xmlns="http://www.w3.org/2000/svg" style="height: 32px; width: auto;">
  ...
  <text x="42" y="28" font-family="Arial, sans-serif" font-size="22" font-weight="bold" fill="#1e3a5f">MANGOS</text>
</svg>
'''
