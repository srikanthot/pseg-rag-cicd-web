"""
Streamlit UI for the MANGOS Tech Manual Assistant.
...
def get_view_css():
    ...
    if st.session_state.get("mobile_view", False):
        ...
        <style>
            ...
            .mangos-header .header-title {
                font-size: 1.1rem !important;
            }

            .mangos-header .header-subtitle {
                font-size: 0.8rem !important;
            }

            .mangos-header .header-badges {
...
st.set_page_config(
    page_title="MANGOS Tech Manual Assistant",
    page_icon="⚡",
    layout="wide",
    initial_sidebar_state="expanded"
)

# MANGOS Enterprise Theme
st.markdown("""
<style>
    :root {
        --mangos-navy: #1e3a5f;
        --mangos-navy-light: #2d5a87;
        --mangos-orange: #f26522;
        --bg-page: #f7f9fc;
        --bg-card: #ffffff;
        --border-color: #e2e8f0;
        --text-primary: #1a1a2e;
    ...
    [data-testid="stChatMessage"]:has([data-testid="stChatMessageAvatar-assistant"]) {
        ...
        border-left: 4px solid var(--mangos-navy);
    }
    ...
    [data-testid="stChatInput"]:focus-within {
        border-color: var(--mangos-navy) !important;
    }

    /* Buttons */
    .stButton > button {
        background: linear-gradient(135deg, var(--mangos-navy) 0%, var(--mangos-navy-light) 100%);
        color: white;
        border: none;
        border-radius: 10px;
        font-weight: 600;
    ...
    .stLinkButton > a {
        background: var(--mangos-orange) !important;
    ...
    .stWarning {
        ...
        border-left: 4px solid var(--mangos-orange) !important;
    ...
    .stInfo {
        ...
        border-left: 4px solid var(--mangos-navy) !important;
        border-radius: 10px !important;
    }
    ...
    .streamlit-expanderHeader {
        ...
        border-radius: 10px !important;
        color: var(--mangos-navy) !important;
    }
    ...
    /* Form elements */
    .stSlider > div > div {
        background: linear-gradient(90deg, var(--mangos-navy), var(--mangos-orange)) !important;
    }

    /* Spinner */
    .stSpinner > div {
        border-top-color: var(--mangos-orange) !important;
    }
...
def render_header():
    """Render the MANGOS branded header using native Streamlit."""
    # Header container with custom styling
    is_mobile = st.session_state.get("mobile_view", False)

    st.markdown(f"""
    <div class="mangos-header" style="background: linear-gradient(135deg, #1e3a5f 0%, #2d5a87 100%);
        ...
        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
            <svg viewBox="0 0 180 50" xmlns="http://www.w3.org/2000/svg" style="height: {'40px' if is_mobile else '50px'}; width: auto; flex-shrink: 0;">
                ...
                <text x="52" y="32" font-family="Arial, sans-serif" font-size="26" font-weight="bold" fill="white">MANGOS</text>
            </svg>
            <div style="flex: 1;">
...
def main():
    ...
    st.markdown(
        ...
        'MANGOS Tech Manual Assistant — Powered by Azure AI</div>',
        unsafe_allow_html=True
    )
