# MANGOS RAG Chatbot - Demo Documentation

## Project Overview

This is an **Enterprise RAG (Retrieval-Augmented Generation) Chatbot** that allows users to ask questions about MANGOS technical manuals and receive accurate, citation-backed answers from PDF documents stored in Azure Blob Storage.
...
- **Enterprise UI**: Professional MANGOS-branded Streamlit interface
...
AZURE_SEARCH_INDEX_NAME=mangos-pdfs-index
...
- Displays MANGOS branded header
...
```bash
git clone https://github.com/your-username/mangos-rag-chatbot.git
cd mangos-rag-chatbot
```
